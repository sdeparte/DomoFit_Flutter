...
class FadeInAndSizeAnimation extends StatelessWidget {
  final double delay;
  final double size;
  final Widget child;

  const FadeInAndSizeAnimation({
    Key? key,
    required this.delay,
    required this.size,
    required this.child,
  ...
  Widget build(BuildContext context) {
    final tween = MultiTween<AnimationProps>()
      ...
      ..add(AnimationProps.size, Tween<double>(begin: 0.0, end: size * (11 / 7)), const Duration(milliseconds: 500), Curves.easeOut);
