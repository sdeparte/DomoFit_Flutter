...
class RoundedAnimationPainter extends CustomPainter {
  final Offset center;
  ...
  RoundedAnimationPainter({required this.context, required this.containerHeight, required this.center, required this.radius, required this.color}) :
